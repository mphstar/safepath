...
import useKategoriKejahatan from "../../Stores/useKategoriKejahatan";
import { Link } from "@inertiajs/react";

const KategoriKejahatan = () => {
    const store = useKategoriKejahatan();

    const [page, setPage] = useState(1);
    const [search, setSearch] = useState("");
    const URL = GenerateUrl(
        "/api/v1/kategori/kejahatan",
        `page=${page}`,
            ...
            <div className="w-full h-full flex flex-col px-3 py-4">
                <div className="flex flex-row mb-8 cursor-pointer">
                    ...
                    <Link href="/admin/kategori/kecelakaan">
                        <div className="px-3 py-2 hover:bg-gray-100">Kecelakaan</div>
                    </Link>
                </div>
...
export default KategoriKejahatan;
