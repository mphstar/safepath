...
import useCctv from "../../Stores/useCctv";
...
const MyModal = ({ URL }) => {
    ...
    return (
        <CustomModal
            ...
            title={store.form.option == "tambah" ? "Tambah CCTV" : "Edit CCTV"}
        >
            <form onSubmit={handleSubmit} action="">
                ...
                <label className="form-control w-full py-2">
                    <div className="label">
                        <span className="label-text required">Url</span>
                    </div>
                    <input
                        name="url"
                        value={store.form.field.url}
                        onChange={store.handleForm}
                        type="text"
                        placeholder=""
                        className="w-full border-2 outline-none px-3 py-2 rounded-[5px]"
