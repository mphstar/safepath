...
const MyModal = ({ URL }) => {
    ...
    return (
        <CustomModal
            ...
            title={
                store.form.option == "tambah" ? "Tambah Polsek" : "Edit Polsek"
            }
        >
            <form onSubmit={handleSubmit} action="">
                <label className="form-control w-full py-2">
                    ...
                    <input
                        name="nama_kecamatan"
                        value={store.form.field.nama_kecamatan}
                ...
                <label className="form-control w-full py-2">
                    ...
                    <input
                        ...
                        value={store.form.field.penanggungjawab}
                        onChange={store.handleForm}
                        type="text"
                        placeholder=""
                        className="w-full border-2 outline-none px-3 py-2 rounded-[5px]"
